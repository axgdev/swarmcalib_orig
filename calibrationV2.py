...
class Calibrator:
    ...
    def getXYCoordinates(self):
         ...
         self.copterTheta = myObj.theta #+ math.pi/2.0
         while (self.copterTheta > 2.0*math.pi):
             self.copterTheta = self.copterTheta - 2.0*math.pi
    ...
    def sendParametersToCopter(self, rollToSend, pitchToSend, yawToSend):
